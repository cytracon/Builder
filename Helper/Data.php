...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * @var \Cytracon\Builder\Model\Source\ResizableSizes
     */
     ...
     * @param \Cytracon\Builder\Model\Source\ResizableSizes $resizableSizes
    ...
    public function __construct(
        ...
        \Cytracon\Builder\Model\Source\ResizableSizes $resizableSizes,
     ...
     * @param  string                         $target
     * @param  string                         $type
     * @param  \Cytracon\Builder\Model\Element $element
     * @param  array                          $attributes
     * @param  string                         $prefix
     * @return string
     */
    public function getStylesHtml(string $target, string $type, \Cytracon\Builder\Model\Element $element, array $attributes, $prefix = '')
    {
        $result = '';
