...
class Element extends ElementStyle implements ElementInterface
{
    ...
    protected function _toHtml()
    {
		$html = parent::_toHtml();
		$element = $this->getElement();
		if (!$this->getCoreRegistry()->registry('cytracon_builder_loadelement')) {
			// Exlude Profile
    ...
    public function getElementsManager()
    {
    	if ($this->_elementsManager==NULL) {
    		$this->_elementsManager = ObjectManager::getInstance()->get(\Cytracon\Builder\Data\Elements::class);
	    }
    ...
    /**
     * @return \Cytracon\Builder\Helper\Data
     */
    public function getDataHelper() {
    	return ObjectManager::getInstance()->get('\Cytracon\Builder\Helper\Data');
    }

    /**
     * @return \Cytracon\Core\Helper\Data
     */
    public function getCoreHelper() {
    	return ObjectManager::getInstance()->get('\Cytracon\Core\Helper\Data');
    }
