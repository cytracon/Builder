define([
	'jquery',
	'Cytracon_Builder/js/vimeo/player',
	'Cytracon_Builder/js/parallax',
    'Cytracon_Builder/js/responsive-typography',
    'Cytracon_Core/js/jquery.magnific-popup.min',
	'waypoints'
], function ($, Vimeo) {
	...
	var mgzInit = function() {
		...
		$('.cytracon-builder').find('.mgz-magnific-link').each(function(index, el) {
		...
		$('.cytracon-builder').find('.mgz-magnific-gallery').each(function(index, el) {
			var options = {
				delegate: 'a',
				type: 'image',
		...
		$('.cytracon-builder').find('.mgz-magnific').each(function(index, el) {
			var type = $(this).data('type') ? $(this).data('type') : 'image';
			var options = {};
	...
	$('body').on('cytraconBuilderLoaded', mgzInit);
	$(document).on('mgz:init', mgzInit);
	$('body').trigger('cytraconBuilderLoaded');
	jQuery(document).ready(function($) {
		$('.cytracon-builder').removeClass('cytracon-builder-preload');
	});
});