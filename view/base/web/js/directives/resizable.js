define([
	...
	var resizableDir = function(cytraconBuilderService, $rootScope) {
		return {
            restrict: 'AE',
            scope: {
            	rElement: '=',
            ...
            link: function(scope, element, attr) {
                scope.sizes = [];
                cytraconBuilderService.getBuilderConfig('resizableSizes', function(resizableSizes) {
                ...
                var updateInfo = function(e) {
                    ...
                    if (size && oldSize!=size) {
                        cytraconBuilderService.setResponiveValue(scope.rElement, 'size', size['value']);
