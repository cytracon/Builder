define([
	...
	var heading = function(cytraconBuilderUrl, $compile, $timeout) {
		return {
			replace: true,
			templateUrl: function(elem) {
				return cytraconBuilderUrl.getTemplateUrl(elem, 'Cytracon_Builder/js/templates/builder/element/heading.html');
			},
