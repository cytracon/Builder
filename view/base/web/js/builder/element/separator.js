define([
	...
	var heading = function(cytraconBuilderUrl, $compile) {
		return {
			replace: true,
			templateUrl: function(elem) {
				return cytraconBuilderUrl.getTemplateUrl(elem, 'Cytracon_Builder/js/templates/builder/element/separator.html');
			},
