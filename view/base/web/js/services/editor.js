define([
    ...
    var editor = function ($rootScope, $timeout, cytraconBuilderFilter) {
        var self = this;
            ...
            settings = {
                ...
                setup: function (editor) {
                    editor.on("BeforeSetContent", function (evt) {
                        if (evt.content) {
                            evt.content = cytraconBuilderFilter.encodeContent(
                                evt.content
                            );
                        }
                    });
                    ...
                    editor.on("change", function (evt) {
                        var value = window.tinyMCE
                            .get(evt.target.id)
                            .getContent();
                        value = cytraconBuilderFilter.decodeContent(value);
            ...
            var settings = {
                ...
                setup: function (ed) {
                    ...
                    ed.onBeforeSetContent.add(function (edi, o) {
                        ...
                        if (o.content) {
                            o.content = cytraconBuilderFilter.encodeContent(
                                o.content
                            );
                        }
                    });
