define([
	'jquery',
	'angular',
	'Cytracon_Builder/js/factories/FormlyUtils'
], function ($, angular, FormlyUtils) {

	var form = function($rootScope, formlyConfig, cytraconBuilderService, $timeout, cytraconBuilderConfig) {
		var self = this;
		...
		this.getForm = function(name, callback, ajaxData) {
			cytraconBuilderService.getBuilderConfig(name, function(result) {
