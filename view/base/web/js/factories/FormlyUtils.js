    ...
    var processFields = function(array, separator, level, key) {
        ...
        for (i; i < length; i++) {
            ...
            if (elem.templateOptions.templateUrl) {
                elem.templateOptions.templateUrl = window.cytraconBuilder.viewFileUrl + elem.templateOptions.templateUrl;
            }

            if (elem.templateOptions.wrapperTemplateUrl) {
                elem.templateOptions.wrapperTemplateUrl = window.cytraconBuilder.viewFileUrl + elem.templateOptions.wrapperTemplateUrl;
            }
