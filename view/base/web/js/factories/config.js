			...
			registerElement: function(name, element) {
				if (!element['element']) {
					if (element['is_collection']) {
						element['element'] = 'Cytracon_Builder/js/builder/element/list';
					} else {
						element['element'] = 'Cytracon_Builder/js/builder/element/base';
					}
				}
				if (!element['navigator']) element['navigator'] = 'Cytracon_Builder/js/navigator/element/base';
				if (element['is_collection']) {
					if (!element['templateUrl']) {
						element['templateUrl'] = 'Cytracon_Builder/js/templates/builder/element/list.html'
					}
					if (!element['navigatorTemplateUrl']) {
						element['navigatorTemplateUrl'] = 'Cytracon_Builder/js/templates/navigator/element/list.html'
					}
				}
