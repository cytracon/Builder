define([
	...
	return {
		...
		controller: function($rootScope, $scope, cytraconBuilderService) {
			...
			cytraconBuilderService.getBuilderConfig('fonts.' + $scope.font, $scope.onSuccess);
			...
			$scope.$watch('font', function(value) {
				$scope.to.loading = true;
				if (value) cytraconBuilderService.getBuilderConfig('fonts.' + value, $scope.onSuccess);
			});
