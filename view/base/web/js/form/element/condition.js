define([
	...
	return {
		controller: function($rootScope, $scope, $sce, cytraconBuilderService) {
			...
			$scope.loadConditionsValue = function() {
				if ($scope.status) {
					...
					cytraconBuilderService.post('mgzbuilder/ajax/conditionsValue', {
			...
			cytraconBuilderService.post('mgzbuilder/ajax/conditions', {
