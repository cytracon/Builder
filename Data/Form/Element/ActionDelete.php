...
class ActionDelete extends AbstractElement
{
    ...
    public function getConfig()
    {
        $config = array_replace_recursive([
            'templateOptions' => [
                'element'            => 'Cytracon_Builder/js/form/element/dynamic-rows/action-delete',
                'templateUrl'        => 'Cytracon_Builder/js/templates/form/element/dynamic-rows/action-delete.html',
