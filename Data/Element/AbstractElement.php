...
abstract class AbstractElement extends \Magento\Framework\DataObject
{
    ...
    /**
     * @var \Cytracon\Builder\Data\Form\Element\Fieldset
     */
    protected $_formTab;
    ...
    /**
     * @var \Cytracon\Builder\Data\Form
     */
    protected $_form;
     ...
     * Get form
     *
     * @return \Cytracon\Builder\Data\Form
     */
            ...
            $common2 = $general->addContainerGroup(
                ...
                $common2->addChildren(
                    ...
                    [
                        ...
                        'templateOptions' => [
                            'label'       => __('Hide on'),
                            'element'     => 'Cytracon_Builder/js/form/element/hide_on',
                            'templateUrl' => 'Cytracon_Builder/js/templates/form/element/hide_on.html',
                        ],
                        'hideExpression' => 'model.disable_element'
                    ]
                );
    ...
    public function prepareModeCssBox($parent, $prefix = '')
    {
        $parent->addChildren(
            ...
            [
                ...
                'sortOrder'       => 0,
                'templateOptions' => [
                    'element'       => 'Cytracon_Builder/js/form/element/simply',
        ...
        $responsive = $this->addTab(
            ...
            $responsive->addChildren(
                ...
                [
                    'sortOrder'       => 0,
                    'templateOptions' => [
                        'content' => __('Find out more details about Responsiveness Control <a href="%1" target="_blank">here</a>', 'https://www.cytracon.com/cytracon-page-builder-responsiveness-control?utm_source=column_settings&utm_medium=element&utm_campaign=builder_extension')
                    ]
                ]
            );
