...
class Conditions extends \Magento\Backend\App\Action
{
    ...
    public function getConditions($parameters, $htmlId) {
        $block = $this->layoutFactory->create()->createBlock('\Cytracon\Core\Block\Adminhtml\Product\Widget\Conditions');
        $block->setTemplate('Cytracon_Builder::product/widget/conditions.phtml');
